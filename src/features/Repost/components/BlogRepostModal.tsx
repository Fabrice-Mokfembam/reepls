...
import { X, MessageCircle, Heart, Share, User2, MoreHorizontal, LucideLoader2 } from 'lucide-react';

import type { User, Article, MediaItem as ArticleMediaItem } from '../../../models/datamodels';
import { useRepostArticle, useUpdateRepost } from '../hooks/useRepost';
...
const RepostStatusModal: React.FC<RepostStatusModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-[4000]">
                ...
                {isLoadingOrError ? (
                  <div>
                    {isLoadingOrError && !article ? (
                      ...
                      <LucideLoader2 size={20} className="animate-spin text-neutral-200 mx-auto my-4" />
                    )}
                  </div>
                ) : (
                  <div className="p-4">
              ...
              <div className="p-4 border-t border-neutral-400 bg-neutral-700">
                <div className="flex items-center justify-end space-x-3">
                  ...
                  >
                    {isPending ? (
                      <>
                        <LucideLoader2 className="animate-spin inline-block mr-2" size={16} />
