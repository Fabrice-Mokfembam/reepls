...
import type { Article, User } from "../../../models/datamodels";
...
const ReactionsPopup: React.FC<ReactionProps> = ({
  ...
  const { allReactions, isLoadingAllReactions,isErrorAllReactions,isErrorReactionsPerType, totalReactions,isLoadingReactionsPerType,reactionsPerType } = useReactions(
  ...
  if (isLoadingAllReactions || isLoadingReactionsPerType) {
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.5)] z-[2000]">
        <div className="bg-background rounded-lg md:w-[50vw] max-w-full shadow-lg h-[80vh] p-4">
          <div className="">
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.5)] z-[910]">
      <div className="bg-background rounded-lg w-[95%] md:w-[50vw] max-w-full shadow-lg h-[50vh] md:h-[80vh]">
