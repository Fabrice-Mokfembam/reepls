...
const {theme} = useTheme()
  return (
    <div className="flex flex-col items-center justify-center size-full bg-background text-neutral-50 p-4 relative">
      {/* Logo */}
...
export default StaticSideAuthScreen;
